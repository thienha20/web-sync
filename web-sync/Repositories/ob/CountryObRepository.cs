...
namespace sync_data.Repositories.ob
{
    ...
    {
        IEnumerable<CountryObModel> GetAll(CountryDto param);
    ...
    public class CountryObRepository : ICountryObRepository
    {
        ...
        public IEnumerable<CountryObModel> GetAll(CountryDto param)
        {
            string fields = "*";
            ...
            return _connection.Query<CountryObModel>(sql, param);
        }
